...
export function MengToSketchbookLandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="VITARA — VIT Mumbai Sketchbook" sourceUrl="/landing-pages/meng-to-sketchbook.html?v=vitara_v4" />;
}
...
export function buildSylvaHeroDocument(variant: Exclude<SylvaHeroVariant, "living-green">) {
  ...
  const rooted = innerGreenSource
    .split(SYLVA_HERO_ASSET_DIR).join(SYLVA_HERO_ASSET_BASE)
